...
!function(){var o={};async function i(){"use strict";canvas;var i,t,e,s,l,a,r,n,c,p,u,y,f,m,d,_,v,h,g,z=canvas();function w(o,i=0){return Number(o.toFixed(i))}async function x(o){g=!g}for(i=ρσ_list_decorate(["3.2","glowscript"]),Array.prototype["+"]=function(o){return this.concat(o)},Array.prototype["*"]=function(o){return __array_times_number(this,o)},window.__GSlang="vpython",t=GSprint,e=range,s="__main__",l=pytype,(0,o.pythonize.strings)(),z.title="Atwood Machine",z.caption="Two masses are connected by a string over a frictionless pulley.",a=ρσ_interpolate_kwargs.call(this,cylinder,[ρσ_desugar_kwargs({pos:vector(0,7,0),axis:vector(0,0,1),radius:1,color:color.gray(.7)})]),r=ρσ_interpolate_kwargs.call(this,box,[ρσ_desugar_kwargs({pos:vec(0,1["-u"]()["*"](.25),0),size:vec(10,.5,5),color:vec(.4,.2,0)})]),n=ρσ_interpolate_kwargs.call(this,box,[ρσ_desugar_kwargs({pos:vector(1["-u"]()["*"](1),3,0),size:vector(1,1,1),color:color.red})]),c=ρσ_interpolate_kwargs.call(this,box,[ρσ_desugar_kwargs({pos:vector(1,1,0),size:vector(1,1,1),color:color.blue})]),p=ρσ_interpolate_kwargs.call(this,cylinder,[ρσ_desugar_kwargs({radius:.05,color:color.yellow})]),u=ρσ_interpolate_kwargs.call(this,cylinder,[ρσ_desugar_kwargs({radius:.05,color:color.yellow})]),p.pos=n.pos["+"](vector(0,n.size.y["/"](2),0)),p.axis=a.pos["+"](vec(1["-u"]()["*"](a.radius),0,0))["-"](1["*"](p.pos)),u.pos=c.pos["+"](vector(0,c.size.y["/"](2),0)),u.axis=a.pos["+"](vec(a.radius,0,0))["-"](1["*"](u.pos)),y=0,f=.01,m=9.8,n.m=4.5,c.m=4,t("Mass 1 (red): "["+"](ρσ_str.format("{}",n.m))["+"](" kg")),t("Mass 2 (blue): "["+"](ρσ_str.format("{}",c.m))["+"](" kg")),d=m["*"](c.m["-"](1["*"](n.m)))["/"](n.m["+"](c.m)),t("Theoretical acceleration: "["+"](ρσ_str.format("{:.2f}",d))["+"](" m/s^2")),n.acceleration=vector(0,d,0),c.acceleration=vector(0,1["-u"]()["*"](d),0),n.velocity=vector(0,0,0),c.velocity=vector(0,0,0),_=ρσ_interpolate_kwargs.call(this,graph,[ρσ_desugar_kwargs({title:"Position vs. Time",xtitle:"Time (s)",ytitle:"Height (m)"})]),v=ρσ_interpolate_kwargs.call(this,gcurve,[ρσ_desugar_kwargs({color:n.color,label:"Mass 1 ("["+"](ρσ_str.format("{}",n.m))["+"](" kg)")})]),h=ρσ_interpolate_kwargs.call(this,gcurve,[ρσ_desugar_kwargs({color:c.color,label:"Mass 2 ("["+"](ρσ_str.format("{}",c.m))["+"](" kg)")})]),await z.pause("Click to Start"),g=!0,x.__argnames__||Object.defineProperties(x,{__argnames__:{value:["evt"]},__module__:{value:null}}),z.bind("click",x);n.pos.y["<"](a.pos.y["-"](1["*"](a.radius)))&&c.pos.y["<"](a.pos.y["-"](1["*"](a.radius)))&&n.pos.y[">"](0["+"](n.size.y["/"](2)))&&c.pos.y[">"](0["+"](c.size.y["/"](2)));)await rate(1["/"](f)),g&&(n.velocity=n.velocity["+"](n.acceleration["*"](f)),c.velocity=c.velocity["+"](c.acceleration["*"](f)),n.pos=n.pos["+"](n.velocity["*"](f)),c.pos=c.pos["+"](c.velocity["*"](f)),p.pos=n.pos["+"](vector(0,n.size.y["/"](2),0)),p.axis=a.pos["+"](vec(1["-u"]()["*"](a.radius),0,0))["-"](1["*"](p.pos)),u.pos=c.pos["+"](vector(0,c.size.y["/"](2),0)),u.axis=a.pos["+"](vec(a.radius,0,0))["-"](1["*"](u.pos)),v.plot(y,n.pos.y),h.plot(y,c.pos.y),y=y["+"](f));t("Simulation finished."),t("Final velocity of mass 1: "["+"](ρσ_str.format("{:.2f}",n.velocity.y))["+"](" m/s")),t("Final velocity of mass 2: "["+"](ρσ_str.format("{:.2f}",c.velocity.y))["+"](" m/s"))}o.pythonize={},function(){function i(){if(i=set("capitalize strip lstrip rstrip islower isupper isspace lower upper swapcase center count endswith startswith find rfind index rindex format join ljust rjust partition rpartition replace split rsplit splitlines zfill".split(" ")),arguments.length)t=arguments[0]?Array.prototype.slice.call(arguments):null;else{var o;t=((o=ρσ_set()).jsset.add("split"),o.jsset.add("replace"),o)}t&&(i=i.difference(set(t)));var i,t,e,s=i;for(var l of s="function"==typeof s[Symbol.iterator]?s instanceof Map?s.keys():s:Object.keys(s))e=l,(ρσ_expr_temp=String.prototype)["number"==typeof e&&e<0?ρσ_expr_temp.length+e:e]=(ρσ_expr_temp=ρσ_str.prototype)["number"==typeof e&&e<0?ρσ_expr_temp.length+e:e]}i.__module__||Object.defineProperties(i,{__module__:{value:"pythonize"}}),o.pythonize.strings=i}(),i.__module__||Object.defineProperties(i,{__module__:{value:null}}),$(function(){window.__context={glowscript_container:$("#glowscript").removeAttr("id")},i()})}();
//--><!]]></script>
</div>
